...
void help() {
    ...
    cout << GREEN << "ALTER TABLE students ADD COLUMN age INT DEFAULT 18;\n" << RESET;
    ...
    cout << GREEN << "SELECT dept, COUNT(*) FROM students GROUP BY dept HAVING COUNT(*) > 1;\n" << RESET;
    cout << GREEN << "SELECT dept, name, COUNT(*) FROM students GROUP BY dept, name;\n" << RESET;
